...
function wrapInternalSendCommand(redis, api) {
    shimmer.wrap(redis.RedisClient.prototype, 'internal_send_command', createInternalSendCommandWrap(api));
}
...
function wrapSendCommand(redis, api) {
    shimmer.wrap(redis.RedisClient.prototype, 'send_command', createSendCommandWrap(api));
}
...
function wrapInstallStreamListeners(redis, api) {
    shimmer.wrap(redis.RedisClient.prototype, 'install_stream_listeners', createStreamListenersWrap(api));
}
...
exports.default = {};
//# sourceMappingURL=plugin-redis.js.map